...
HD_PWD='/home/dorfell/Documents/Vitis_2019.2/socs_design/02_microblaze_axi/02_microblaze_axi.runs/microblaze_bd_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_bd_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_bd_ilmb_v10_0.tcl
