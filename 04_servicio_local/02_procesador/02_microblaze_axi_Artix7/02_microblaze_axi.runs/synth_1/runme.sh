...
HD_PWD='/home/javier/Desktop/Debian2/02_microblaze_axi_Artix7/02_microblaze_axi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_bd_wrapper.tcl
