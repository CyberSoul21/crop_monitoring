...
HD_PWD='/home/javier/Desktop/Debian2/02_microblaze_axi_Artix7/02_microblaze_axi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_bd_wrapper.tcl -notrace
