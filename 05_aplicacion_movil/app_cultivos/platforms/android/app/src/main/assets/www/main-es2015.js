...
const routes = [
    ...
    {
        path: 'alert',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-alert-alert-module */ "pages-alert-alert-module").then(__webpack_require__.bind(null, /*! ./pages/alert/alert.module */ "./src/app/pages/alert/alert.module.ts")).then(m => m.AlertPageModule)
    },
    {
        path: 'action-sheet',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-action-sheet-action-sheet-module */ "pages-action-sheet-action-sheet-module").then(__webpack_require__.bind(null, /*! ./pages/action-sheet/action-sheet.module */ "./src/app/pages/action-sheet/action-sheet.module.ts")).then(m => m.ActionSheetPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /home/sebas/Documentos/ionic/componentes18/src/main.ts */"./src/main.ts");
